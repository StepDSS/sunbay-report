  ...
  return (
    <section id="competitive">
      ...
      <div className="section-toggles">
        <SectionToggle label="International">
        ...
        <SectionToggle label="Polish Competitors">
          <div style={{ overflowX: 'auto' }}>
            <table>
        ...
        <SectionToggle label="Sources" variant="source">
          <ul>
            <li><a href="https://vindicat.pl" target="_blank" rel="noopener noreferrer">vindicat.pl</a> — debt recovery, 169 PLN/mo or 6% success fee, 20K+ users, Polish Fintech of Year 2023</li>
            <li>Comarch ERP Optima (60K+ users) — collections module within ERP. wFirma — basic email reminders at 49 PLN/mo.</li>
            <li>Revenue estimates: Upflow $4.1M (<a href="https://getlatka.com/companies/upflow" target="_blank" rel="noopener noreferrer">Getlatka</a>). Chaser &lt;$1M (<a href="https://www.owler.com/company/chaserhq" target="_blank" rel="noopener noreferrer">Owler</a>) to $5.2M (<a href="https://growjo.com/company/Chaser" target="_blank" rel="noopener noreferrer">Growjo</a>). Gaviti $3.8-6.6M (<a href="https://getlatka.com/companies/gaviti" target="_blank" rel="noopener noreferrer">Getlatka</a>). Tesorio ~$11M (LeadIQ).</li>
            <li>Employees: <a href="https://tracxn.com/d/companies/upflow/" target="_blank" rel="noopener noreferrer">Tracxn</a>, <a href="https://pitchbook.com/profiles/company/104545-63" target="_blank" rel="noopener noreferrer">PitchBook</a>, LinkedIn. Funding: <a href="https://www.crunchbase.com" target="_blank" rel="noopener noreferrer">Crunchbase</a>, PitchBook, <a href="https://app.dealroom.co/companies/chaser_1" target="_blank" rel="noopener noreferrer">Dealroom</a>.</li>
            <li>Chaser: files "total exemption full accounts" at <a href="https://find-and-update.company-information.service.gov.uk/company/08517987/filing-history" target="_blank" rel="noopener noreferrer">UK Companies House</a> — does not disclose revenue.</li>
            <li>competitive_landscape_indirect.md — debt recovery industry PLN 3.7B, 89 firms, 6,801 employees (GUS 2024). B2B claims ~0.9M cases/year.</li>
          </ul>
        </SectionToggle>
      </div>
    </section>
